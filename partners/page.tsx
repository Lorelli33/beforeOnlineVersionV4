...
import { createPartnerSubscription } from '@/lib/partnerPayments';
...
export default function Partners() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Create subscription
      const { error: subscriptionError } = await createPartnerSubscription({
        tierId: selectedTier.id,
        tierType: activeTab === 'partners' ? 'partner' : 'yacht',
        price: selectedTier.price,
        currency: 'EUR',
        name: activeTab === 'partners' ? formData.companyName : formData.yachtName,
