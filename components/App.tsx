...
import TokenRewardsWidget from './TokenRewardsWidget';
...
// Debug logging for jetCategories
console.log('jetCategories:', jetCategories);
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (savedState) {
      try {
        ...
        if (state.showMultiLeg) setShowMultiLeg(state.showMultiLeg);
      } catch (error) {
  ...
  }, [origin, destination, selectedDate, selectedTime, returnDate, returnTime, isReturn, stops, selectedJet, bookingDetails, showMultiLeg]);
  ...
  const calculateRoute = () => {
    ...
    try {
      ...
      console.log('bookingDetails.passengers:', bookingDetails.passengers);
